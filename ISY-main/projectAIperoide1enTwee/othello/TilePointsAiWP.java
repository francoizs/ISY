...
public class TilePointsAiWP extends AiOthello {
     ...
     */
    public TilePointsAiWP(int playernumber, char piece) {
     ...
     */
    public int moveselectOthello8(Othello AIBoard, char piece) {
