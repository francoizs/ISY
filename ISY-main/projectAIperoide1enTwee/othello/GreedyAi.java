...
public class GreedyAi extends AiOthello {
     ...
     */
    public int moveselectOthello1(Othello AIBoard, char piece, int maxdepth) {
        ...
        for (int position = 0; position < 64; position++) {
            if (AIBoard.allowMoveOthello(position, piece)) {
                ...
                int positionValue = minimax(AIBoard, maxdepth, oppPiece, false, Integer.MIN_VALUE, Integer.MAX_VALUE);
